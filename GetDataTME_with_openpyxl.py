        ...
        if flag != 1:
            ...
            try :
                ...
                if all_data['Data']['ProductList'][0]['Photo'] == "":
                    ...
                    sheet['E'+str(j+1)] = "https://" + all_data['Data']['ProductList'][0]['Photo'][2:] # "https://" + 
    ...
    for j in range(rng1,rng2):
        ...
        if flag != 1:
            ...
            if articles_list[j] != None:
                ...
                try:
                    all_data = product_import_tme(token, app_secret, action2, params) # НЕ РАБОТАЕТ если не найденый артикул, по какой то причине есть во второй колонке !!!
